  ...
  return (
    <>
      ...
      >
        <Search size={13} />
        <span>Buscar...</span>
        <span className="ml-auto text-[10px] px-1.5 py-0.5 rounded bg-app-subtle border border-app text-ink-subtle">
          ⌘K
        </span>
      </button>
        ...
        {open && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-[580px] rounded-2xl overflow-hidden glass shadow-modal"
            ...
            >
              ...
              <div className="flex items-center gap-3 px-4 py-3.5 border-b border-app">
                ...
                <kbd className="hidden sm:block text-[10px] px-1.5 py-0.5 rounded border border-app bg-app-subtle text-ink-subtle">
                  Esc
                </kbd>
              </div>
              ...
              >
                {/* Empty query hint */}
                {!query.trim() && (
                  <p className="px-4 py-6 text-center text-[13px] text-ink-subtle">
                        ...
                        return (
                          ...
                          >
                            <div className="flex-1 min-w-0">
                              ...
                              {item.sublabel && (
                                <div className="text-[11.5px] text-ink-subtle truncate mt-0.5">
                                  {item.sublabel}
                                </div>
                              )}
                            </div>
                            ...
                            <ArrowRight
                              size={13}
                              className={`flex-shrink-0 text-ink-subtle transition-opacity ${
